package com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database
...
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.converters.DateTimeConverters
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.dao.ActivityDao
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.dao.HotelDao
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.dao.NotificationDao
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.dao.ReservationActivityDao
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.dao.ReservationDao
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.dao.TransportDao
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.dao.TripDao
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.dao.UserDao
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.dao.UserFavoriteDao
...
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.entities.HotelEntity
...
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.entities.ReservationActivityEntity
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.entities.ReservationEntity
...
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.entities.TripEntity
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.entities.UserEntity
import com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.database.entities.UserFavoriteEntity
    ...
    companion object {
        ...
        private suspend fun initializeSampleTrips(database: TripBookDatabase) {
            try {
                ...
                val dummyTrips = com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.providers.DummyTripDataProvider.getTrips()
                ...
                tripEntities.forEach { tripEntity ->
                    val transportOptions = com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.providers.DummyTripDataProvider
        ...
        private suspend fun initializeSampleHotels(database: TripBookDatabase) {
            try {
                ...
                val dummyHotels = com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.providers.DummyHotelProvider.getHotels()
        ...
        private suspend fun initializeSampleActivities(database: TripBookDatabase) {
            try {
                ...
                val dummyActivities = com.android.tripbook.reservation.fogangmenyefortunybachyr.ictu20223271.reservationpayment.data.providers.DummyActivityProvider.getActivities()
