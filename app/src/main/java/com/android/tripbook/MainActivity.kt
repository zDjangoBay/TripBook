...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Get OpenWeatherMap API key (you'll need to add this to your manifest)
        val weatherApiKey = applicationContext.packageManager
            .getApplicationInfo(packageName, android.content.pm.PackageManager.GET_META_DATA)
            .metaData.getString("com.openweathermap.API_KEY") ?: ""

        val googleMapsService = GoogleMapsService(applicationContext, apiKey)
        val weatherService = WeatherService(weatherApiKey)
    ...
    fun TripBookApp(
        ...
        when (currentScreen) {
            ...
            "TripDetails" -> TripDetailsScreen(
                ...
                // Removed weatherService parameter here
            )
            ...
            "TravelAgency" -> TravelAgencyScreen(
                ...
                onServiceSelected = { service: AgencyService, type: ItineraryType ->
                    selectedTrip?.let { trip ->
